...
function formatRatingDisplay(rating){if(!rating)return '정보 없음';const cleanRating=rating.trim();if(cleanRating.includes('⭐')){const match=cleanRating.match(/(\d+(?:\.\d+)?%)/);return match?match[1]:'정보 없음';}return cleanRating;}
