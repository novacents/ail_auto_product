...
<label for="thumbnail_url" style="color:rgba(255,255,255,0.9);margin-bottom:8px;display:block;">썸네일 이미지 URL</label>
...
<div class="title-section" style="display:inline-block;margin-left:20px;">
