<?php
/**
 * 어필리에이트 상품 등록 자동화 입력 페이지 - 최적화 버전
 * 노바센트(novacents.com) 전용 - CSS/JS 분리 + 썸네일 URL 기능 추가
 */
...
<link rel="stylesheet" href="assets/affiliate_editor.css">
</head>
<body>
<!-- 로딩 오버레이 -->
...
<h3>🖼️ 썸네일 이미지 <small style="color: #666;">(선택사항 - 글 대표 이미지)</small></h3>
<div class="form-row">
<div class="form-field thumbnail-url-field">
<label for="thumbnailUrl">썸네일 이미지 URL</label>
<input type="url" id="thumbnailUrl" placeholder="예: https://example.com/image.jpg" oninput="updateThumbnailPreview()">
<img id="thumbnailPreview" class="thumbnail-preview" alt="썸네일 미리보기" style="display: none;">
</div>
</div>
</div>
...
<script src="assets/affiliate_editor.js"></script>
</body>
</html>